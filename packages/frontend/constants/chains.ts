...
import arbitrumLogoUrl from '../assets/images/arbitrum_logo.svg'
import optimismLogoUrl from '../assets/images/optimistic_ethereum.svg'
...
export const TEST_CHAINS: SupportedChainId[] = [
  // SupportedChainId.ROPSTEN,
  SupportedChainId.RINKEBY,
  SupportedChainId.GOERLI,
  // SupportedChainId.KOVAN,
...
export const MORALIS_CHAIN_NAMES = {
...
export const CHAIN_INFO: ChainInfo = {
  ...
  [SupportedChainId.POLYGON]: {
    ...
    statusPage: 'https://polygon.technology/stats/',
    bridge : 'https://wallet.polygon.technology/bridge',
    infoLink :'https://polygon.technology/about/'
  },
  [SupportedChainId.POLYGON_MUMBAI]: {
    docs: 'https://polygon.technology/',
...
export const OPTIMISM_HELP_CENTER_LINK =
  ...
  export function isTestChain( id : SupportedChainId){
    const index=  TEST_CHAINS.findIndex(t=> {return t == id });
    return index >= 0;
   }


   // const contractAddresses = {
//     1 :{chainId:1,chain:'ETH',networkName:'mainnet',address:'0x51598ae36102010feca5322098b22dd5b773428b'},
//     4 : {chainId:4,chain:'ETH',networkName:'rinkeby',address:'0x6ac6baf770b3ffe2ddb3c5797e47c17cebef2ec4'},
//     137: {chainId:137,chain:'MATIC',networkName:'Polygon',address:null}
// }
